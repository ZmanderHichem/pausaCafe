  ...
  Future<List<Map<String, dynamic>>> loadFromLocalStorage() async {
    try {
      ...
      if (jsonString != null) {
        ...
        List<Map<String, dynamic>> factureDataList =
            jsonDataList.map((json) => json as Map<String, dynamic>).toList();
        ...
        Card(
          child: ListTile(
            title: Row(
              ...
              children: [
                Expanded(
                  // Use Expanded for '${item['LIBELLEARTICLE']}' to allow wrapping
                  child: Text(
                    '${item['LIBELLEARTICLE']}',
                ...
                const SizedBox(
                    width:
                        8), // Add space between '${item['LIBELLEARTICLE']}' and '${item['DATEFACT']}'
                Text(
                  // '${item['DATEFACT']}' positioned at the right
                  '${item['DATEFACT']}',
            ...
            subtitle: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8), // Add some space between lines
                const Text(
                  'Prochain entretien: ',
                  style: TextStyle(color: Colors.blue, fontSize: 17),
                ),
